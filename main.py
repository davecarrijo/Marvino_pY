...
wake_msg = "Bom dia caralho tou up"

help_msg = """Eu respondo os seguindos comandos:

/start - Fico ativo.
/about - O que eu sou?.
/explain - Explico como eu funciono
/help - Eu mando essa mensagem.
/count - Conto quantas mensagens deste grupo eu lembro.
/period - Change the period of my messages. (Maximum of 100000)
/speak - Força a eu interagir.
...
about_msg = "I am yet another  Bot experiment. I read everything you type to me and then spit back nonsensical messages that look like yours.\n\nYou can send /explain if you want further explanation."
